            ...
            switch (choice) {
                case 1:
                    ...
                    if (confirmation.equalsIgnoreCase("yes")) {
                        inventoryManagement.addItem(addItemName, addQuantity);
                ...
                case 2:
                    ...
                    if (inventoryManagement.inventory.containsKey("Frooty " + removeItem)) {
                        ...
                        inventoryManagement.removeItem(removeItem, removeQuantity);
                    } else {
                        System.out.println("Item not found in inventory.");
                    }
                    break;
